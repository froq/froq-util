...
/**
 * Get a random item from given array, filling ref'ed key with found key if wanted.
 *
 * @param  array       $array
...
/**
 * Get a random items from given array by given limit, filling ref'ed key with found key if wanted.
 *
 * @param  array              $array
 * @param  int                $limit
